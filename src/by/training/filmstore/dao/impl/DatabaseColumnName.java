...
public final class DatabaseColumnName {
	...
	/*name of film table columns*/
	/*name of film_actor table columns*/
	static final String TABLE_FILM_ACTOR_FM_ID = "fm_id";
	static final String TABLE_FILM_ACTOR_ACT_ID = "act_id";
	/*name of film_actor table columns*/
	/*name of actor table columns*/
	static final String TABLE_ACTOR_ACT_UID = "act_uid";
	static final String TABLE_ACTOR_ACT_FIO = "act_fio";
	/*name of actor table columns*/
	/*name of film_director table columns*/
	static final String TABLE_FILM_DIRECTOR_FD_UID = "fd_uid";
	static final String TABLE_FILM_DIRECTOR_FD_FIO = "fd_fio";
	/*name of film_director table columns*/
