...
public class GoodOfOrderDAOImpl implements GoodOfOrderDAO{
	...
	private static final String TABLE_GOOD_OF_ORDER_FILM_ID  = "fm_id";
	private static final String TABLE_GOOD_OF_ORDER_ORDER_ID  = "ord_id";
	private static final String TABLE_GOOD_OF_ORDER_COUNT_FILMS  = "gd_count_films";
	...
	private void fillGoodOfOrder(GoodOfOrder goodOfOrder,ResultSet resultSet) throws SQLException{
		...
		goodOfOrderPK.setIdFilm(resultSet.getShort(TABLE_GOOD_OF_ORDER_FILM_ID));
		goodOfOrderPK.setIdOrder(resultSet.getInt(TABLE_GOOD_OF_ORDER_ORDER_ID));
		goodOfOrder.setId(goodOfOrderPK);
		goodOfOrder.setCountFilms(resultSet.getByte(TABLE_GOOD_OF_ORDER_COUNT_FILMS));
	}
}
