...
public class FilmDAOImpl implements FilmDAO {
	...
	private static final String TABLE_FILM_UID = "fm_uid";
	private static final String TABLE_FILM_NAME = "fm_name";
	private static final String TABLE_FILM_GENRE= "fm_genre";
	private static final String TABLE_FILM_COUNTRY = "fm_country";
	private static final String TABLE_FILM_YEAR_OF_RELEASE = "fm_year_of_release";
	private static final String TABLE_FILM_QUALITY = "fm_quality";
	private static final String TABLE_FILM_FILM_DIRECTOR = "fm_film_director";
	private static final String TABLE_FILM_DESCRIPTION = "fm_description";
	private static final String TABLE_FILM_PRICE = "fm_price";
	private static final String TABLE_FILM_COUNT_FILM = "fm_count_film";
	private static final String TABLE_FILM_IMAGE = "fm_image";
	...
	{
		film.setId(resultSet.getShort(TABLE_FILM_UID));
		film.setName(resultSet.getString(TABLE_FILM_NAME));
		film.setGenre(resultSet.getString(TABLE_FILM_GENRE));
		film.setCountry(resultSet.getString(TABLE_FILM_COUNTRY));
		film.setYearOfRelease(resultSet.getShort(TABLE_FILM_YEAR_OF_RELEASE));
		Quality quality = Quality.valueOf(resultSet.getString(TABLE_FILM_QUALITY).replaceFirst("-", ""));
		film.setQuality(quality);
		film.setFilmDirector(resultSet.getShort(TABLE_FILM_FILM_DIRECTOR));
		film.setDescription(resultSet.getString(TABLE_FILM_DESCRIPTION));
		film.setPrice(resultSet.getBigDecimal(TABLE_FILM_PRICE));
		film.setCountFilms(resultSet.getShort(TABLE_FILM_COUNT_FILM));
		Blob image = resultSet.getBlob(TABLE_FILM_IMAGE);
