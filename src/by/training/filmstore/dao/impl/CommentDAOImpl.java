...
public class CommentDAOImpl implements CommentDAO{
	...
	public Comment find(CommentPK id) throws FilmStoreDAOException {
		...
		{
			logger.error("Error creating of PreparedStatement.Can't find comment");
	...
	public boolean create(Comment entity) throws FilmStoreDAOException {
		...
		try{
			...
			logger.error("Error creating of PreparedStatement.Can't create comment");
			throw new FilmStoreDAOException(e);
		}
		finally {
			try {
	...
	public boolean delete(CommentPK id) throws FilmStoreDAOException {
		...
		try{
			...
			logger.error("Error creating of PreparedStatement.Can't delete comment");
			throw new FilmStoreDAOException(e);
		}
		finally {
			try {
	...
	private <T> List<Comment> findCommentByCriteria(T parametr,FindCommentCriteria criteria ) throws FilmStoreDAOException{
		...
		try {
			...
			logger.error("Error creating of PreparedStatement.Can't find comment("+criteria.name()+")");
			throw new FilmStoreDAOException(e);
		}
		finally {
			try {
	...
	private void fillComment(Comment comment,ResultSet resultSet) throws SQLException{
		...
		commentPK.setUserEmail(resultSet.getString("cm_email_user"));
		commentPK.setFilmId(resultSet.getShort("cm_film"));
		comment.setId(commentPK);
		comment.setContent(resultSet.getString("cm_content"));
		comment.setDate(resultSet.getTimestamp("cm_date"));
	}
