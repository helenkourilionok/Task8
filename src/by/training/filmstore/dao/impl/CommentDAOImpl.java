...
public class CommentDAOImpl implements CommentDAO{
	...
	private void fillComment(Comment comment,ResultSet resultSet) throws SQLException{
		...
		commentPK.setUserEmail(resultSet.getString(DatabaseColumnName.TABLE_COMMENT_EMAIL_USER));
		commentPK.setFilmId(resultSet.getShort(DatabaseColumnName.TABLE_COMMENT_FILM_ID));
		comment.setId(commentPK);
		comment.setContent(resultSet.getString(DatabaseColumnName.TABLE_COMMENT_CONTENT));
		comment.setDate(resultSet.getTimestamp(DatabaseColumnName.TABLE_COMMENT_DATE));
	}
