...
public class OrderDAOImpl implements OrderDAO{
	...
	public Order find(Integer id) throws FilmStoreDAOException {
		...
		{
			logger.error("Error creating of PreparedStatement.Can't find order");
	...
	public boolean create(Order entity) throws FilmStoreDAOException {
		...
		try{
			...
			logger.error("Error creating of PreparedStatement.Can't create order");
			throw new FilmStoreDAOException(e);
		}
		finally {
			try {
	...
	public boolean update(Order entity) throws FilmStoreDAOException {
		...
		try{
			...
			logger.error("Error creating of PreparedStatement.Can't update order fields");
			throw new FilmStoreDAOException(e);
		}
		finally {
			try {
	...
	public boolean delete(Integer id) throws FilmStoreDAOException {
		...
		try{
			...
			logger.error("Error creating of PreparedStatement.Can't delete order");
			throw new FilmStoreDAOException(e);
		}
		finally {
			try {
	...
	private List<Order> findOrderByCriteria(String parametr, FindOrderCriteria criteria) throws FilmStoreDAOException {
		...
		try {
			...
			logger.error("Error creating of PreparedStatement.Can't find order("+criteria.name()+")");
			throw new FilmStoreDAOException(e);
		}
		finally {
			try {
	...
	{
		order.setUserEmail(resultSet.getString("ord_email_user"));
		order.setCommonPrice(resultSet.getBigDecimal("ord_common_price"));
		order.setStatus(Status.getStatusByName(resultSet.getString("ord_status")));
		order.setKindOfDelivery(KindOfDelivery.getKindOfDeliveryByName(resultSet.getString("ord_kind_of_delivery")));
		order.setKindOfPayment(KindOfPayment.getKindOfPaymentByName(resultSet.getString("ord_kind_of_payment")));
		order.setDateOfOrder(resultSet.getDate("ord_date_of_order"));
		order.setDateOfDelivery(resultSet.getDate("ord_date_of_delivery"));
		order.setAddress(resultSet.getString("ord_address"));
	}
}
