...
public class OrderDAOImpl implements OrderDAO{
	...
	private static final String TABLE_ORDER_UID = "ord_uid";
	private static final String TABLE_ORDER_EMAIL_USER = "ord_email_user";
	private static final String TABLE_ORDER_COMMON_PRICE = "ord_common_price";
	private static final String TABLE_ORDER_STATUS = "ord_status";
	private static final String TABLE_ORDER_KIND_OF_DELIVERY = "ord_kind_of_delivery";
	private static final String TABLE_ORDER_KIND_OF_PAYMENT = "ord_kind_of_payment";
	private static final String TABLE_ORDER_DATE_OF_ORDER = "ord_date_of_order";
	private static final String TABLE_ORDER_DATE_OF_DELIVERY = "ord_date_of_delivery";
	private static final String TABLE_ORDER_ADDRESS = "ord_address";
	...
	{
		order.setId(resultSet.getInt(TABLE_ORDER_UID));
		order.setUserEmail(resultSet.getString(TABLE_ORDER_EMAIL_USER));
		order.setCommonPrice(resultSet.getBigDecimal(TABLE_ORDER_COMMON_PRICE));
		order.setStatus(Status.getStatusByName(resultSet.getString(TABLE_ORDER_STATUS)));
		order.setKindOfDelivery(KindOfDelivery.getKindOfDeliveryByName(resultSet.getString(TABLE_ORDER_KIND_OF_DELIVERY)));
		order.setKindOfPayment(KindOfPayment.getKindOfPaymentByName(resultSet.getString(TABLE_ORDER_KIND_OF_PAYMENT)));
		order.setDateOfOrder(resultSet.getDate(TABLE_ORDER_DATE_OF_ORDER));
		order.setDateOfDelivery(resultSet.getDate(TABLE_ORDER_DATE_OF_DELIVERY));
		order.setAddress(resultSet.getString(TABLE_ORDER_ADDRESS));
	}
}
